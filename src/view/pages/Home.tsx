...
const Home = () => {
  return (
    <Box mx={2} my={1}>
      <h1>介绍</h1>
      <p>
        三大功能：虚拟屏幕，OCR图像转文字，机器翻译。
        <strong>目前正在开发阶段，部分功能暂时不可用。</strong>
      </p>
      <h2>虚拟屏幕</h2>
      <p>
      ...
      <h2>OCR图像转文字</h2>
      <p>
        在视频源中出现的文字可以通过OCR功能转换成文本，目前支持中文，英文，日文3种语言，更多语言正在完善中。
      </p>
      <p>
        OCR功能完全免费，OCR的所有组件均可以离线运行，但为了提高ocr质量，t
        trans会随机上传您的OCR图像用于优化OCR模型。
      </p>
      <h2>机器翻译</h2>
      <p>
      ...
      <p>测试阶段提供一个有限字符测试key：(Free-Translate)</p>
      <h2>
